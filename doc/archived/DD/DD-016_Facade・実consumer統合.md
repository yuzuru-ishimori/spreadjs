...
| 作成日 | 更新日 | ステータス | 補足 |
|--------|--------|-----------|------|
| 2026-07-14 | 2026-07-14 | 完了 | 案Y 2分割＝アンブレラ化。**DD-016-1＋DD-016-2 完了**（Facade実装・物理抽出・S1-3実証・CG-1統合後スモークPASS・CG-6精密メモリPASS〔redraw境界化〕）。AC1〜8 全充足。DD-012 アンブレラ（AC2/AC4）クローズ可。派生=DD-016-3（ナビ修正）。要確認①〜⑤ 確定済 |
...
- [x] **DD-016-2 完了**（2026-07-14・S1-3 実証・pack closure・再mount leak／**CG-1 統合後スモーク PASS**〔Chrome6＋Edge3=9 sessions・先頭欠落0・順序B〕・**CG-6 精密メモリ PASS**〔peak 65.3MB≪300MB・純減リークなし・redraw 境界化〕・cg-ledger CG-1/CG-6 解除）。派生=DD-016-3（ナビ focus/scroll-follow 修正・完了）
- [x] DD-012 アンブレラ（AC2/AC4）クローズ連絡済（DD-012 ログ 2026-07-14）・**本DD（DD-016）AC1〜8 全充足＝完了**
...
### 2026-07-14（アンブレラ完了）
- **DD-016-2 完了**（S1-3 実証・pack closure・再mount leak／CG-1 統合後スモーク PASS〔Chrome6＋Edge3=9 sessions・先頭欠落0・順序B・両ブラウザ〕／CG-6 精密メモリ PASS〔`--enable-precise-memory-info` flag run・peak 65.3MB≪300MB・純減リークなし〕＋redraw 境界化〔要確認④既定・§18.2 上限12ms・render 無変更ゆえ計測アーティファクト〕）。cg-ledger CG-1/CG-6 解除済。
- **本アンブレラ（DD-016）AC1〜8 全充足＝完了**。DD-012 アンブレラ（AC2/AC4）クローズ連絡済（DD-012 ログ）。**派生子DD=DD-016-3**（アクティブセルキーボードナビ focus保持・scroll-follow 修正／DD-016-2 CG-1 テスト中に発見・完了）。
- 未実施の後続=**DD-017**（配布〔private registry〕・CHANGELOG・Quick Start・Tier 1 matrix 実測）・**DD-018**（Stage 1 移行判定・baseline 空最終確認）。
- **DA批判レビュー**: 本DDはアンブレラ（実作業・ゲート・DAは子DDで実施）ゆえ本体の DA表は雛形のまま＝**DA は子DD（DD-016-1/016-2）で記録済み**（雛形残置は仕様どおり・不要）。
