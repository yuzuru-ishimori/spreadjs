...
| 作成日 | 更新日 | ステータス | 補足 |
|--------|--------|-----------|------|
| 2026-07-14 | 2026-07-14 | 確認待ち | 親=DD-014。Codex xhigh P1 findings（P1-3〜P1-7）を解消し **CG-3 解除**（DD-014＋DD-014-1）。ADR-0023 Accepted。**AC1〜AC8 充足・E2E green・Codex 2巡目 P1×4 も全対応**。P2-1/P2-3/P2-4 は親DD-014 既知制約。コミット待ち |
