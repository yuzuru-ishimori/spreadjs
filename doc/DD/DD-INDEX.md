...
| DD-021-2 | 行操作収束・競合 | 検討中 | 親=DD-021（3分割の第2子・実装順2番目）。同時 Insert/Delete 収束・競合 UX・K4 synthetic |
| DD-021-3 | 選択再ベース・性能 | 検討中 | 親=DD-021（3分割の第3子・実装順3番目）。K3 回収・Undo 生存整合・P2-1 Θ(N²) 是正 |
