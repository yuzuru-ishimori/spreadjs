...
DD-023 ロードマップ策定（本DD）
  ...
  → DD-026 consumer 統合①開始（売上入力の要件調査 ＝ 機能DD順序の変化点。KPI 採取開始）
...
|---|---|---|---|
| P-01 | 正式製品名 | Stage 1 リリース前（**超過**） | **命名ゲート（§2・DD-025 起票前）でユーザー決定**（公開パッケージ名/scope/import に波及するため consumer 統合前。反映作業=DD-031） |
| P-14 | リポジトリ名称変更（`spreadjs`→） | Stage 1 Alpha 前（**超過**） | 同上（命名ゲートで P-01 と同時決定・反映作業=DD-031） |
